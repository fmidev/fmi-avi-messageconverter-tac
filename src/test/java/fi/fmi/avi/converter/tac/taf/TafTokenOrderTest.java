...
public class TafTokenOrderTest extends AbstractAviMessageTest<String, TAF> {
	...
	public String getMessage() {
		return
				"TAF EFAB 190815Z 1909/1915 14008G15MPS 9999 BKN010 -RA BKN015=";
	}
	...
	public Identity[] getLexerTokenSequenceIdentity() {
		return spacify(new Identity[] {
				TAF_START, AERODROME_DESIGNATOR, ISSUE_TIME, VALID_TIME, SURFACE_WIND, HORIZONTAL_VISIBILITY, CLOUD, WEATHER, CLOUD, END_TOKEN });
	}

...
public class SWXTACParserTest {
    ...
    public void testParser1() throws Exception {
        ...
        final ConversionResult<SpaceWeatherAdvisoryAmd79> result = this.converter.convertMessage(input, TACConverter.TAC_TO_SWX_POJO);
        ...
        for (int x = 0; x < originalList.size(); x++) {
            ...
            for (int i = 0; i < modifiedList.size() - 1; i++) {
                ...
                if (!comparisonTac.equals(modifiedTac)) {
                    final ConversionResult<SpaceWeatherAdvisoryAmd79> result = this.converter.convertMessage(modifiedTac, TACConverter.TAC_TO_SWX_POJO);
    ...
    public void testLongitudesWithoutSpacesAroundDashes() throws Exception {
        ...
        final ConversionResult<SpaceWeatherAdvisoryAmd79> spacedResult = this.converter.convertMessage(spacedInput, TACConverter.TAC_TO_SWX_POJO);
        final ConversionResult<SpaceWeatherAdvisoryAmd79> spacelessResult = this.converter.convertMessage(spacelessInput, TACConverter.TAC_TO_SWX_POJO);

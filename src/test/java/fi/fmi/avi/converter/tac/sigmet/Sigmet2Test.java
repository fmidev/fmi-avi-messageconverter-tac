...
public class Sigmet2Test extends AbstractAviMessageTestTempSigmet<String, SIGMET> {
	...
	public String getMessage() {
		return "EHAA SIGMET 1 VALID 111130/111530 EHDB- EHAA AMSTERDAM FIR OBSC TSGR FCST AT 1200Z ENTIRE FIR INTSF="; // FCST AT 1530Z ENTIRE FIR FCST AT 1530Z N52 E00520=";

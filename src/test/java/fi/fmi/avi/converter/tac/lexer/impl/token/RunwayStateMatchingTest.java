...
public class RunwayStateMatchingTest {
    ...
    public void test16th_ed_99421594() {
        final Matcher m = runwayState.getPattern().matcher("99421594");
    ...
    public void test16th_ed_15Rslashes() {
        final Matcher m = runwayState.getPattern().matcher("15R//////");
    ...
    public void test16th_ed_14CLRD__() {
        final Matcher m = runwayState.getPattern().matcher("14CLRD//");
    ...
    public void test19th_ed_R99_421594() {
        final Matcher m = runwayState.getPattern().matcher("R99/421594");
    ...
    public void test19th_ed_R14L_CLRD__() {
        final Matcher m = runwayState.getPattern().matcher("R14L/CLRD//");

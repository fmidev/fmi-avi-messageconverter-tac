...
public class Sigmet2TestPoint extends AbstractAviMessageTestTempSigmet<String, SIGMET> {
	...
	public String getMessage() {
		return "EHAA SIGMET 1 VALID 111130/111530 EHDB- EHAA AMSTERDAM FIR OBSC TSGR FCST AT 1200Z N5200 E00520 INTSF="; // FCST AT 1530Z ENTIRE FIR FCST AT 1530Z N52 E00520=";
...
//		return "EHAA SIGMET M01 VALID 111130/111530 EHDB-\nEHAA NEW AMSTERDAM FIR SEV ICE (FZRA) OBS ENTIRE FIR=";
	...
	public LexemeIdentity[] getLexerTokenSequenceIdentity() {
        return spacify(new LexemeIdentity[] { SIGMET_START, REAL_SIGMET_START,
				...
				PHENOMENON_SIGMET, OBS_OR_FORECAST, POLYGON_COORDINATE_PAIR,
				END_TOKEN });
	}

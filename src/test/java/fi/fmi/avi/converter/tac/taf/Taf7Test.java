...
public class Taf7Test extends AbstractAviMessageTest<TAF> {
	...
	public String getMessage() {
		return "TAF EFHK 012350Z NIL=";
	}

	@Override
	public LexemeIdentity[] getLexerTokenSequenceIdentity() {
		return spacify(new LexemeIdentity[] { TAF_START, AERODROME_DESIGNATOR, ISSUE_TIME, NIL, END_TOKEN });
	}

...
public class Sigmet2TestPolygon extends AbstractAviMessageTestTempSigmet<String, SIGMET> {
	...
	public String getMessage() {
		return "EHAA SIGMET 1 VALID 111130/111530 EHDB- EHAA AMSTERDAM FIR OBSC TSGR FCST AT 1200Z WI N5200 E00520 - N5300 E00620 - N5100 E00720 - N5200 E00520 INTSF="; // FCST AT 1530Z ENTIRE FIR FCST AT 1530Z N52 E00520=";
	}
	...
	public LexemeIdentity[] getLexerTokenSequenceIdentity() {
        return spacify(new LexemeIdentity[] { SIGMET_START, REAL_SIGMET_START,
				...
				PHENOMENON_SIGMET, OBS_OR_FORECAST, SIGMET_WITHIN,
				POLYGON_COORDINATE_PAIR, POLYGON_COORDINATE_PAIR_SEPARATOR,
				POLYGON_COORDINATE_PAIR, POLYGON_COORDINATE_PAIR_SEPARATOR,
				POLYGON_COORDINATE_PAIR, POLYGON_COORDINATE_PAIR_SEPARATOR,
				POLYGON_COORDINATE_PAIR, SIGMET_INTENSITY,
				END_TOKEN });
	}

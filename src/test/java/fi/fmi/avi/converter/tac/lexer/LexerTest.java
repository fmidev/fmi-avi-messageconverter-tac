...
public class LexerTest {
    ...
    public void testSplit() {
        ...
        Assert.assertEquals("Incorrect number of split sequences", 6, splitUp.size());
    ...
    public void testSpaceWeatherLexing() {
        ...
        LexemeSequence seq = lexer.lexMessage(SWX_ADVISORY);
    ...
    public void testSpaceWeatherLexingWithConversionHint() {
        ...
        LexemeSequence seq = lexer.lexMessage(SWX_ADVISORY, ConversionHints.SPACE_WEATHER_ADVISORY);
        Lexeme le = seq.getFirstLexeme();

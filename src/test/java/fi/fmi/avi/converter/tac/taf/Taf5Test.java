...
public class Taf5Test extends AbstractAviMessageTest<String, TAF> {
	...
	public Identity[] getLexerTokenSequenceIdentity() {
		return spacify(new Identity[] {
                ...
                TAF_CHANGE_FORECAST_TIME_GROUP, SURFACE_WIND, TAF_FORECAST_CHANGE_INDICATOR, TAF_CHANGE_FORECAST_TIME_GROUP, SURFACE_WIND, TAF_FORECAST_CHANGE_INDICATOR,
                TAF_CHANGE_FORECAST_TIME_GROUP, SURFACE_WIND, END_TOKEN
		});
	}

...
public class SigmetVaTest extends AbstractAviMessageTestTempSigmet<String, SIGMET> {

	@Override
	public String getJsonFilename() {
		return "../sigmet/sigmetva.json";
	}

	@Override
	public String getMessage() {
		return "EHAA SIGMET 4 VALID 171610/172210 EHDB-\r\n"
			+"EHAA AMSTERDAM FIR VA ERUPTION MT SABANCAYA PSN S1547 W07150 VA CLD"
...
//		return "EHAA SIGMET M01 VALID 111130/111530 EHDB-\nEHAA NEW AMSTERDAM FIR SEV ICE (FZRA) OBS ENTIRE FIR=";
	...
	public LexemeIdentity[] getLexerTokenSequenceIdentity() {
        return spacify(new LexemeIdentity[] { SIGMET_START,
				...
				SIGMET_VA_ERUPTION, SIGMET_VA_NAME, SIGMET_VA_POSITION, SIGMET_PHENOMENON,

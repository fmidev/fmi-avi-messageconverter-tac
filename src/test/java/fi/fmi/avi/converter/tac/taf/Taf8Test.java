...
public class Taf8Test extends AbstractAviMessageTest<TAF> {
    ...
    public String getMessage() {
        return "TAF EFVA 270930Z 2712/2812 14015G25KT 8000 -RA SCT020 OVC050\r\n" //
    ...
    public LexemeIdentity[] getLexerTokenSequenceIdentity() {
        return spacify(
                new LexemeIdentity[] { TAF_START, AERODROME_DESIGNATOR, ISSUE_TIME, VALID_TIME, SURFACE_WIND, HORIZONTAL_VISIBILITY, WEATHER, CLOUD, CLOUD,
                        ...
                        SURFACE_WIND, TAF_FORECAST_CHANGE_INDICATOR, TAF_CHANGE_FORECAST_TIME_GROUP, HORIZONTAL_VISIBILITY, TAF_FORECAST_CHANGE_INDICATOR,

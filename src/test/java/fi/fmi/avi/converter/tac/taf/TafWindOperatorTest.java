...
public class TafWindOperatorTest extends AbstractAviMessageTest<String, TAF> {
    ...
    public String getJsonFilename() {
        return "taf/taf_wind_operators.json";
    }
    ...
    public Identity[] getLexerTokenSequenceIdentity() {
        return spacify(new Identity[] { TAF_START, AERODROME_DESIGNATOR, ISSUE_TIME, VALID_TIME, SURFACE_WIND, CAVOK, TAF_FORECAST_CHANGE_INDICATOR,

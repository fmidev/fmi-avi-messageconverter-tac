...
public interface Lexeme {
    ...
    enum Identity {
        ...
        AIR_PRESSURE_QNH(VALUE, UNIT), SURFACE_WIND(DIRECTION, MAX_VALUE, MEAN_VALUE, UNIT, RELATIONAL_OPERATOR, RELATIONAL_OPERATOR2),
        ...
        TAF_CHANGE_FORECAST_TIME_GROUP(DAY1, DAY2, HOUR1, HOUR2, MINUTE1), TREND_CHANGE_INDICATOR(TYPE), NO_SIGNIFICANT_CHANGES,
        ...
        WIND_SHEAR(RUNWAY),
        SEA_STATE(UNIT, UNIT2, VALUE), RUNWAY_STATE(RUNWAY, VALUE), SNOW_CLOSURE,
    ...
    enum ParsedValueName {
        ...
        TENDENCY_OPERATOR, RUNWAY, SEQUENCE_NUMBER
    }

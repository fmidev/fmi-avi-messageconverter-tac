...
public class LexemeIdentity {
    ...
    public static final LexemeIdentity SWX_EFFECT = new LexemeIdentity("SWX_EFFECT", EnumSet.of(PHENOMENON), Collections.emptySet());
    public static final LexemeIdentity SWX_INTENSITY = new LexemeIdentity("SWX_INTENSITY", EnumSet.of(INTENSITY), Collections.emptySet());
